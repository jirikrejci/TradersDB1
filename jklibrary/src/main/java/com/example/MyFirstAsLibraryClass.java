...
public class MyFirstAsLibraryClass {
    ...
    public static void show () {
        System.out.println("Ahoj z AndroidStudia projektu TradersDB1 - knihovna jklibrary, Tøída My First Library Class show - ahoj, kurva, to je ale døina");
    }

    /**
     * Vypise Hello s oslovenim
